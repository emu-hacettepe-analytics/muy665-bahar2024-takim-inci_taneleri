...
Bu kapsamda 8 farklı grafik ile elimdeki veri setini analiz edeceğiz.

## 1-Haftaiçi ve Haftasonu Gerçekleşen Üretim Grafiğinin Aylara Göre Dağılımı

![](portfolyo/Proje/1-Haftaiçi-HaftaSonu.png){fig-align="center"}
...
data <- read.csv("../muy665-bahar2024-takim-inci_taneleri/ElkUrtm23.csv", fileEncoding="UTF-8-BOM") #dosyayolunu kendi dosya yolunuza göre güncellemelisiniz.
...
## 2-Üretim Türüne Göre Mevsimsel Dağılım Grafiği

![](portfolyo/Proje/2-Üretim_Türüne_Göre_Mevsimsel.png){fig-align="center"}
...
# Veriyi doğru kodlama ile okuyun
data <- read.csv("../Downloads/ElkUrtm23.csv", fileEncoding="UTF-8-BOM")#dosyayolunu kendi dosya yolunuza göre güncellemelisiniz.

...
Doğalgaz ve ithal kömür, Ocak ayında en çok kullanılan enerji kaynakları. Kışın soğuk havalarıyla birlikte enerji talebi artıyor, bu yüzden bu iki kaynak yoğun bir şekilde kullanılmış. Fuel Oil ve taş kömür kullanımının düşük seviyelerde olduğunu görüyoruz. Belki de bu dönemde daha maliyetli veya daha az verimli oldukları için tercih edilmemişler. Nisan Ayı:

Bahar aylarına gelindiğinde doğalgaz kullanımı düşüş göstermiş. Muhtemelen hava ısındığı için ısıtma ihtiyacı azalmış ve doğalgaz talebi de buna bağlı olarak azalmış. İthal kömür yine en yüksek seviyede kullanılmış. Görünüşe göre, bu dönemlerde kömür, enerji üretiminde önemli bir rol oynamış. Fuel Oil ve taş kömür yine düşük seviyelerde kalmış. Bu kaynaklar genellikle yedek enerji kaynakları olarak kullanılıyor olabilir. Temmuz Ayı:

Yaz aylarında doğalgaz ve ithal kömür kullanımı zirve yapmış. Yazın enerji talebi artar çünkü insanlar klimalarını daha fazla kullanır. Bu dönemde ithal kömür kullanımı rekor seviyelere ulaşmış. Belki de enerji talebinin karşılanmasında kömür santralleri önemli bir rol oynamış. Fuel Oil ve taş kömür yine düşük seviyelerde ama sabit kalmış. Bu kaynaklar, daha çok ani ihtiyaçlar için yedek tutuluyor olabilir. Ekim Ayı:

Sonbaharda, doğalgaz kullanımı tekrar artmış. Havanın soğumaya başlamasıyla birlikte ısınma ihtiyacı da artmış olabilir. İthal kömür kullanımı biraz düşmüş ama yine de yüksek seviyelerde kalmış. Fuel Oil ve taş kömür ise yıl boyunca olduğu gibi düşük seviyelerde kalmaya devam etmiş. Genel olarak, yıl boyunca enerji kaynaklarının kullanımı mevsimsel değişikliklere bağlı olarak dalgalanma göstermiş. Kış aylarında doğalgaz, yaz aylarında ise ithal kömür en çok kullanılan kaynaklar olmuş. Fuel Oil ve taş kömür ise yıl boyunca daha az kullanılmış, belki de yedek enerji kaynağı olarak rol oynamışlar. Bu veriler, enerji talebi ve üretim stratejileri hakkında bize önemli ipuçları veriyor.
